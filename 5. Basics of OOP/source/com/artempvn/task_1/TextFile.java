//—оздать объект класса “екстовый файл, использу¤ классы ‘айл, ƒиректори¤. ћетоды: создать, переименовать, 
...
System.out.println("‘айл переименован");
} catch (Exception ex){System.err.println("‘айл не найден");};
