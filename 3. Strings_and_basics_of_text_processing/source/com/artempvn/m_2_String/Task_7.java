// ¬водитс¤ строка. “ребуетс¤ удалить из нее повтор¤ющиес¤ символы и все пробелы. Ќапример, если было введено "abc cde
...
char ch=' ';
for (int i=0;i<a.length();i++){
	if(a.charAt(i)!=ch&&i==a.indexOf(a.charAt(i))){
...
print(a);
System.out.println("»змененна¤ строка: ");
function(a);
	}	
}
}
